...
prompt = FewShotPromptTemplate(
    ...
    prefix="You are a summarizer who receives text extracted from a webpage and converts the words into an organized list of information separated by new lines. Format your curated information as a list of information where each piece of information is separated by a newline. Include all information from the text, only excluding very minor details. If the text has no important or relevant information, respond with \"No relevant information\"",
